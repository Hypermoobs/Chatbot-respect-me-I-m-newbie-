  ...
  cron.schedule('*/10 * * * *', () => {
    ...
    api.getThreadList(25, null, ['INBOX'], async (err, data) => {
      ...
      async function message(thread) {
        try {
          api.sendMessage({
            body: `⟩ hello I'm Tantan Thank you for using my Bot!\n\n⟩ \n\n⟩ For your concerns about the Bot, kindly add and follow me on FB: https://www.facebook.com/profile.php?id=100084553454309&mibextid=ZbWKwL`
          }, thread.threadID, (err) => {
            if (err) return;
